export const PIPELINE_REASON_CODES = {
  ...
  ANALYSIS_NOT_NEEDED: "analysis_not_needed",
  ANALYSIS_DECIDED_NO_REPLY: "analysis_decided_no_reply",
...
export type PipelineReasonCode =
  (typeof PIPELINE_REASON_CODES)[keyof typeof PIPELINE_REASON_CODES];
...
const PIPELINE_REASON_LABELS: Record<PipelineReasonCode, string> = {
  ...
  [PIPELINE_REASON_CODES.ANALYSIS_NOT_NEEDED]: "Analysis not needed",
  [PIPELINE_REASON_CODES.ANALYSIS_DECIDED_NO_REPLY]: "Deprecated no-reply decision",
  [PIPELINE_REASON_CODES.AUTO_GENERATION_FIRST_INBOUND_ONLY]: "Auto generation only for first inbound text",
  [PIPELINE_REASON_CODES.REVIEW_DISABLED]: "Review disabled",
